...
import poke from "../../public/image-removebg-preview_7.png";
import retard from "../../public/fb3635d8481962e7696ab1481481d52d.png";
import trainer from "../../public/nobg1.png";
import x from "../../public/x.png";
import tg from "../../public/Telegram.png";

export const Header = () => {
  return (
    <div className="h-full flex flex-col lg:flex-row lg:justify-between mx-2">
      <div className="lg:w-1/2  flex flex-col mt-10 gap-10 mx-2">
        <Image src={retard} />
      ...
      <div className="flex w-1/2 my-3 lg:m-2">
        <Image src={trainer} className="lg:w-1/2" />
        <Image src={poke} className="lg:w-1/2" />
      </div>
    </div>
  );
};
